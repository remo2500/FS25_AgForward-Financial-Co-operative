...
local PRODUCTS = {
    [AGFProductType.OPERATING_LINE] = {
        ...
        supportsFlexiblePaymentFrequency = false,
        supportsSeasonalPaymentAnchor = false,
        supportsInterestOnlyPhase = false,
        supportsRateTermRenewal = false,
        supportsPrepaymentPolicy = false,
        supportsStagedDraws = false,
        supportsBorrowingBase = false,
        supportsHarvestSweep = false,
    ...
    [AGFProductType.CROP_INPUT_LINE] = {
        ...
        supportsBalloon = false,
        supportsFlexiblePaymentFrequency = false,
        supportsSeasonalPaymentAnchor = true,
        supportsInterestOnlyPhase = false,
        supportsRateTermRenewal = false,
        supportsPrepaymentPolicy = false,
        supportsStagedDraws = false,
        supportsBorrowingBase = true,
        supportsHarvestSweep = true,
        directPurchaseFunding = true,
    ...
    [AGFProductType.TERM_LOAN] = {
        ...
        supportsFlexiblePaymentFrequency = true,
        supportsSeasonalPaymentAnchor = true,
        supportsInterestOnlyPhase = true,
        supportsRateTermRenewal = true,
        supportsPrepaymentPolicy = true,
        supportsStagedDraws = false,
        supportsBorrowingBase = false,
        supportsHarvestSweep = false,
