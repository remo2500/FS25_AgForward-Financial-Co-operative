...
assertTrue(string.find(exports.periodSummaryCSV, "2026,9,3,30000%.00,35000%.00,-5000%.00") ~= nil, "period summary row")
assertTrue(string.find(exports.expenseCategoryCSV, "2026,9,fertilizer,-30000%.00") ~= nil, "expense category row")
assertTrue(string.find(exports.fundingSourceCSV, "2026,10,cash,-500%.00") ~= nil, "funding source row")
