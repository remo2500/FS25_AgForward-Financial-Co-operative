...
assertTrue(string.find(exports.periodSummaryCSV, "2026,9,3,30000,35000,-5000") ~= nil, "period summary row")
assertTrue(string.find(exports.expenseCategoryCSV, "2026,9,fertilizer,-30000") ~= nil, "expense category row")
assertTrue(string.find(exports.fundingSourceCSV, "2026,10,cash,-500") ~= nil, "funding source row")
